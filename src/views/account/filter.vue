		...
		<modal :show.sync="resultModal">
			...
			<span slot="body">
				<ul class="list-reset block y-scrollable">
					...
					<a @click="resultModal = false" v-link="{ name: 'mail', params: { accountId: $route.params.accountId, folderId: result.folder.folderId, messageId: result.messageId }}" class="btn">
